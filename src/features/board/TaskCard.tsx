...
export const TaskCard = ({ task, assigneeName, onClick }: TaskCardProps) => {
  return (
    <button
      onClick={onClick}
      className="w-full transform-gpu rounded-xl border border-slate-200 bg-white p-4 text-left shadow-sm transition-all duration-200 ease-out hover:-translate-y-0.5 hover:border-slate-300 hover:bg-white hover:shadow-md active:translate-y-0 focus:outline-none"
    >
